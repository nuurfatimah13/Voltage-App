<x-app-layout title="Update Monitoring">
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10">
                <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 mb-2">Edit Data Monitoring</h3>
                    </div>
                </div>

                <!-- Form untuk mengedit data -->
                <form method="POST" action="{{ route('involtage.update', $involtage->id) }}">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                            :value="old('name', $involtage->name)" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="location" class="block mt-1 w-full" type="text" name="location"
                            :value="old('location', $involtage->location)" required autocomplete="location" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="voltage" class="block mt-1 w-full" type="number" name="voltage"
                            :value="old('voltage', $involtage->voltage)" required autocomplete="voltage" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="information" class="block mt-1 w-full" type="text" name="information"
                            :value="old('information', $involtage->information)" required autocomplete="information" />
